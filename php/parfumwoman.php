...
$products = "SELECT * FROM products WHERE type2='parfum' AND type1='woman'";
...
<body>
    ...
    <div class="litle-header">
        <div class="wtc">
            ...
            <div class="popup-contianer">
                <a  class="active"  style="padding: 10px;"nclick="watches()">Watches <i class="fa-solid fa-angle-down"></i></a>
                <div class="popup">
                    <a class="active"  href="watches.php">All</a>
                    <a class="active"  href="watchesman.php">Man</a>
                    <a class="active"  href="watcheswoman.php">Woman</a>
                </div>
            </div>
            <div class="popup-contianer">
                <a style="color: blue;" class="active" style="padding: 10px;">Perfum <i class="fa-solid fa-angle-down"></i></a>
                <div class="popup">
                    <a class="active"  href="parfum.php">All</a>
                    <a class="active"  href="parfumman.php">Man</a>
                    <a class="active" id="activo" href="parfumwoman.php">Woman</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <section>
        <center>
            <h1 class="titre">Woman perfums</h1>
        </center>

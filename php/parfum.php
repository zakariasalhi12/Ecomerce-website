...
$products = "SELECT * FROM products WHERE type2='parfum'";
    ...
    <div class="litle-header">
        <div class="wtc">
            ...
            <div class="popup-contianer">
                <a class="active"  style="padding: 10px;" nclick="watches()">Watches <i
            ...
            <div class="popup-contianer">
                <a style="color:blue;" class="active"  style="padding: 10px;">Perfum <i
                        class="fa-solid fa-angle-down"></i></a>
                <div class="popup">
                    <a class="active" id="activo" href="parfum.php">All</a>

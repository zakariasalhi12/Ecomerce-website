...
$products = "SELECT * FROM products WHERE type2='parfum' AND type1='man'";
        ...
        <div class="wtc">
            ...
            <div class="popup-contianer">
                ...
                <div class="popup">
                    ...
                    <a class="active" id="activo" href="parfumman.php">Man</a>

...
$products = "SELECT * FROM products WHERE type2='watch' AND type1 ='woman' ";
...
<body>
        ...
        <div class="wtc">
            ...
            <div class="popup-contianer">
                ...
                <div class="popup">
                    ...
                    <a class="active" id="activo" href="watcheswoman.php">Woman</a>
                </div>
            </div>
            <div class="popup-contianer">
    ...
    <section>
        <center>
            <h1 class="titre">Woman watches</h1>
        </center>
